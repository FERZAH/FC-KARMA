...
module.exports.run = async (client, message, args, embed) => {
    ...
    if (!message.member.voice.channel || message.member.voice.channel.id != ayar.channels.meeting) return message.channel.send({ embeds: [embed.setDescription(`Bu komutu kullanabilmek için toplantı ses kanalında bulunmalısın.`)] }).sil(7);
